...
library CryptoSuite{
    function splitSignature(bytes memory sig) internal pure returns (uint8 v, bytes32 r, bytes32 s){
        ...
        assembly{ //accessing virtual machine to chnage low level changes
...
contract ColdChain {
    ...
    enum Mode { ISSUER, PROVER, VERIFIER} //roles
    struct Entity {
        address id;
        Mode mode;
    ...
    enum Status { MANUFACTURED, DELIVERING_INTERNATIONAL, STORED, DELIVERING_LOCAL, DELIVERED } //STAUS OF CERTIFICATE
